"""
Django settings for itcaser project.
...
WSGI_APPLICATION = 'itcaser.wsgi.application'
...
PAYMENT_MODEL = 'main.Payment'

# PayMe configuration for paymeuz
